...
import com.shaxhxnk.rnspark.Message
import com.shaxhxnk.rnspark.User
import com.shaxhxnk.rnspark.adapters.MessagesAdapter
import com.shaxhxnk.rnspark.util.DATA_CHATS
import com.shaxhxnk.rnspark.util.DATA_MESSAGES
...
class ChatActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if(chatId.isNullOrEmpty() || userId.isNullOrEmpty() || imageUrl.isNullOrEmpty() || otherUserId.isNullOrEmpty()) {
            Toast.makeText(this, "Chat room error, Upload image", Toast.LENGTH_SHORT).show()
            finish()
        }
